...
@BackboneRegistry.register("ncsnpp-50")
class NCSNpp50(nn.Module):
    """NCSN++ model, adapted from https://github.com/yang-song/score_sde repository"""
    ...
    def __init__(self,
        ...
        **unused_kwargs
        ...
        if embedding_type == 'fourier':
            modules.append(layerspp.GaussianFourierProjection(
                embedding_size=nf, scale=fourier_scale*10
            ))
            embed_dim = 2 * nf
        elif embedding_type == 'positional':
            embed_dim = nf
...
@BackboneRegistry.register("ncsnpp-m")
    ...
    def __init__(self, 
        ...
        **kwargs):
        ...
        if self.discriminative:
            ...
            conditional = False
            scale_by_sigma = False
            print("Running NCSN++M as discriminative backbone")
